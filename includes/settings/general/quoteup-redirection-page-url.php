...
function redirectPageUrlSection($form_data)
{
    ...
    <fieldset>            
        ...
        <?php echo '<legend>'.__('Redirect Page URL', QUOTEUP_TEXT_DOMAIN).'</legend>';
    ?>
        <div class="fd">
            <div class='left_div'>
                <label for="wdm_redirect_user"> <?php _e('Page Url', QUOTEUP_TEXT_DOMAIN) ?></label>
            </div>
            <div class='right_div'>
            <?php
            $helptip = __('User will be forwarded to this on successful Quote request. Leave blank if not needed', QUOTEUP_TEXT_DOMAIN);
