...
if ( !class_exists( 'WisdmForm_SettingsAPI' ) ):
class WisdmForm_SettingsAPI {
    ...
    function callback_text( $args ) {
        ...
        $html = sprintf( '<input type="text" class="%1$s-text form-control" id="%2$s[%3$s]" name="%2$s[%3$s]" value="%4$s"/>', $size, $args['section'], $args['id'], $value );
    ...
    function callback_textarea( $args ) {
        ...
        $html = sprintf( '<textarea rows="5" cols="55" class="%1$s-text form-control" id="%2$s[%3$s]" name="%2$s[%3$s]">%4$s</textarea>', $size, $args['section'], $args['id'], $value );
        $html .= sprintf( '<p class="description"> %s</p>', $args['desc'] );
    ...
    function callback_color( $args ) {
        ...
        $html .= sprintf( '<p class="description" style="display:block;"> %s</p>', $args['desc'] );
    ...
    function section_tabs() {
        ...
        foreach ( $this->settings_sections as $tab ) {
            ...
            $html .= sprintf( '<a href="#%1$s" id="%1$s-tab" data-toggle="tab">%2$s</a>', $tab['id'], $tab['title'] );
            $html .= '</li>';
        }
        echo $html;
    }
    ...
    function show_forms() {
        ...
        <div class="tab-content">
                ...
                <?php foreach ( $this->settings_sections as $form ) { $active = isset($active)?'':'active' ?>
                    <div id="<?php echo $form['id']; ?>" class="tab-pane <?php echo $active; ?>">
                        <form method="post" action="options.php">
                            <?php do_action( 'settings_form_top_' . $form['id'], $form ); ?>
                            <?php settings_fields( $form['id'] ); ?>
                            <?php $this->do_settings_sections( $form['id'] ); ?>
                            <?php do_action( 'settings_form_bottom_' . $form['id'], $form ); ?>
