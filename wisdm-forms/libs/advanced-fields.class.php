...
class advancedfields {
    ...
    public static function address($params = array()) {
        ...
        $countries_hidden_div = "<div class='hidden' id='wisdmform_json_countries'>{$countries}</div>";
        $states_hidden_div = "<div class='hidden' id='wisdmform_json_states'>{$states}</div>";
        ...
        return $ret_html. "<script type='text/javascript'>jQuery(document).ready(function(){jQuery('.select2element').select2();});</script>". ($show_states == true ? $state_populate_js : "");
