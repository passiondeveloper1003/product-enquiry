...
?>
<link rel="stylesheet" href="<?php echo WF_BASE_URL ?>views/css/morris-0.4.3.min.css">
<script src="<?php echo WF_BASE_URL ?>views/js/raphael-min.js"></script>
<script src="<?php echo WF_BASE_URL ?>views/js/morris-0.4.3.min.js"></script>
<div class="wrap">
    <div class="w3eden">
