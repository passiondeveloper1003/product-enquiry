...
?>
    ...
    public function field_render_html($params = array())
    {
        ...
        <div id="<?php echo $params['id'] ?>" class='form-group <?php echo isset($params['conditioned']) ? " conditioned hide " : ''?>' data-cond-fields="<?php echo $condition_fields ?>" data-cond-action="<?php echo $cond_action.':'.$cond_boolean ?>" >
            ...
            ?>
            <div class='form-group'>
                <input type='text' class='form-control' name='submitform[<?php echo $name ?>]' id='urlfield_<?php echo $params['id'] ?>' <?php echo required($params); ?> placeholder='<?php echo esc_attr(quoteupReturnCustomFormFieldPlaceholder($params['label'])); ?>' value='<?php echo isset($params['url']) ? $params['url'] :''  ?>'/>
                <div>
